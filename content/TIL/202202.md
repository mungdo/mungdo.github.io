...
[블로그 포스트 1](https://mungdo-log.tistory.com/319?category=1001171)
[블로그 포스트 2](https://mungdo-log.tistory.com/321?category=1001171)
...
4. 평균
5. 표준편차 (분산^1/2)
6. 순열과 조합 : 순서가 있는 뽑기, 순서가 없는 뽑기
7. 기하분포 : 베르누이 시행 반복시 언제 성공할지 구하기(시도하는 횟수)
8. 이항분포 : 베르누이 시행 반복시 성공 횟수 구하기
9. 포아송 분포 : 주어진 구간(단위 시간)에서 사건이 발생하는 수
10. 정규분포
    1. 확률밀도함수
    2. 기댓값과 분산
11. 모집단과 표본
